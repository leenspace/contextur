...
The `<!-- contextur:repo-specific-start -->` and `<!-- contextur:repo-specific-end -->` markers let `contextur-update` find and replace this block later without touching the rest of the file.
